...
.team-card figure { margin: 0; flex-shrink: 0; width: 160px; }
.team-card figure img { width: 160px; height: 190px; object-fit: cover; border-radius: 8px; display: block; }
.team-info { flex: 1; min-width: 0; }
.team-info p, .team-info span { text-align: left; }
